...
def create_or_update_campaign(cmpobj):
    ...
    yield db_utils.update_campaign(cmpobj.campaign_id,
                                   cmpobj.time_start,
                                   cmpobj.time_end,
                                   cmpobj.filters.to_josn(),
                                   cmpobj.keywords.to_json())
...
if __name__ == "__main__":
    keywords = {u'context_lorem': 1, u'locale': u'en_us', u'banner_size': u'160x600', u'context_lipsum': 1,
                u'device_type': u'desktop', u'zone': u'website.priv/2', u'tid': u'7e_dy_8i1u3gofhjxq9jgzdahwfj7g',
                u'inframe': u'no', u'screen_width': 1920, u'context_what': 1, u'host': u'website.priv',
                u'path': u'website.priv/', u'context_facts': 1, u'context_ipsum': 1, u'context_generator': 1,
                u'context_lorem ipsum': 1, u'context_text': 1, u'browser_name': u'firefox', u'context_information': 1,
