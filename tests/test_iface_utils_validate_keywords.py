...
from adselect.iface.utils import validate_exclude_keywords, validate_keywords, validate_require_keywords
...
class TestExcludeValidateKeywords(TestCase):
...
class TestRequireValidateKeywords(TestCase):
