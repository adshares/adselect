...
from adselect.contrib import const as contrib_const, logs as contrib_logs
...
class TestContribLogs(unittest.TestCase):
    ...
    def test_configure_setup(self):
        ...
        # Test default setup
        contrib_logs.setup()
        self.assertEqual(logging.getLogger().getEffectiveLevel(), getattr(logging, contrib_const.LOG_LEVEL))
        ...
        # Test custom setup
        contrib_logs.utils_consts.LOG_CONFIG_JSON_FILE = True
