...
#: Limit new banners.
NEW_BANNERS_IMPRESSION_CUTOFF = int(os.getenv('ADSELECT_NEW_BANNERS_IMPRESSION_CUTOFF', 1000000))

#: The amount of returned banners.
SELECTED_BANNER_MAX_AMOUNT = int(os.getenv('ADSELECT_SELECTED_BANNER_MAX_AMOUNT', 1000))
